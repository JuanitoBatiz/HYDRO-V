...
export function Sidebar({
  ...
  return (
    <aside
      className="hidden md:flex flex-col w-72 min-h-screen shrink-0 bg-white border-r border-neutral-200 shadow-sm"
    ...
    >
      ...
      <div className="flex items-center gap-3 px-6 py-5 border-b border-neutral-200">
        <div
          ...
          style={{ background: '#0e8de6', boxShadow: '0 2px 4px rgba(14,141,230,0.25)' }}
        >
          <Droplets className="w-6 h-6 text-white" aria-hidden="true" />
        </div>
        <div>
          <span className="text-xl font-black text-neutral-900">Hydro-V</span>
          <p className="text-sm text-neutral-500">Tu agua, bajo control</p>
        </div>
      </div>

      {/* Device info pill */}
      <div
        className="mx-4 mt-5 px-4 py-3 rounded-2xl"
      ...
      >
        ...
        <p className="text-base font-bold" style={{ color: '#094984' }}>{deviceCode}</p>
        <div className="flex items-center gap-1.5 mt-1">
          <span
            ...
            aria-hidden="true"
          />
          <span className="text-sm font-medium" style={{ color: '#166534' }}>Conectado</span>
        </div>
      </div>
          ...
          return (
            ...
            >
              <Icon
                ...
                style={{ color: isActive ? '#0558a0' : '#94a3b8' }}
                aria-hidden="true"
              />
      ...
      <div className="px-3 py-4 border-t border-neutral-200 space-y-1">
        ...
        >
          <Bell className="w-5 h-5 text-neutral-400" aria-hidden="true" />
